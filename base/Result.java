          ...
          String priceResponse  = getApiData(allPriceAPi);
              ...
              for(int i =0; i< jsonArray.length(); i++){
                  if(jsonArray.get(i) instanceof JSONObject){
                      ...
                      String finalValue = (String)jsnObj.get("date");
                      String finalValue1 = (String)jsnObj.get("security");
                      String finalValue2= (String)jsnObj.get("quantity");
                      String finalValue3 = (String)jsnObj.get("portfolio");
                  }
              }
